...
app.use(
  cors({
    origin: [
      "http://savemyreels.vercel.app",
      "http://localhost:5173",
      "https://insta-video-downloader-backend.vercel.app",
    ], // Allow these origins
    methods: "GET, POST", // Allow these HTTP methods
    allowedHeaders: "Content-Type, Authorization, X-Custom-Header", // Allow these headers
    exposedHeaders: "X-Custom-Header", // Expose custom headers to the client
    credentials: true, // Allow cookies to be sent with cross-origin requests
    preflightContinue: false, // Pass control to the next middleware for preflight requests
  })
);
